...
# df = pd.read_csv("bike_sharing_daily.csv") directly from the current directory
# Using os.path to ensure compatibility across different environments

file_path = os.path.join(os.path.dirname(__file__), "bike_sharing_daily.csv")
